CREATE DATABASE IF NOT EXISTS `logic_projector`
...
CREATE TABLE IF NOT EXISTS `export_tasks` (
  ...
  CONSTRAINT `fk_export_tasks_generation_task_id`
    FOREIGN KEY (`generation_task_id`) REFERENCES `generation_tasks` (`id`),
  CONSTRAINT `fk_export_tasks_user_id`
    FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `billing_records` (
  ...
  CONSTRAINT `fk_billing_records_user_id`
    FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `fk_billing_records_task_id`
